# Credit-Risk-Analysis-Data-Mining
Automated loan screening pipeline using K-Medoids clustering, fuzzy logic, and genetic algorithms on 25K credit risk records.
